...
class MyTestCase(unittest.TestCase):
    ...
    def test_lengthPointX(self):
        ...
        f = open('../Ex4/data/A3')
        a.load_from_json_graph(json.load(f))
        x = a.get_graph().get_node_x(0)  # 35.18750930912026
        x1 = a.get_graph().get_node_x(1)  # 35.18961076190476
    ...
    def test_lengthPointY(self):
        ...
        f = open('../Ex4/data/A3')
        a.load_from_json_graph(json.load(f))
        y = a.get_graph().get_node_y(0)  # 32.10374591260504
        y1 = a.get_graph().get_node_y(1)  # 32.10794390084033
    ...
    def test_lengthBetween2Segment(self):
        ...
        f = open('../Ex4/data/A3')
        a.load_from_json_graph(json.load(f))
        x = a.length_point_x(a.get_graph().get_node_x(0), a.get_graph().get_node_x(1))  # 0.0021014527844986984
        y = a.length_point_y(a.get_graph().get_node_y(0), a.get_graph().get_node_y(1))  # 0.004197988235286435
    ...
    def test_load_from_json_pokemons(self):
        ...
        try:
            ...
            json_file = open("../Ex4/data/pokemon.json", "w")
    ...
    def test_load_from_json_agents(self):
        ...
        try:
            ...
            json_string = json.dumps(a_list)
            json_file = open("../Ex4/data/agent.json", "w")
            json_file.write(json_string)
            json_file.close()
        except:
            print("Error")
